<template>
  <header class="bg-gray-900/80 backdrop-blur-md text-white sticky top-0 z-50 border-b border-gray-800">
    <nav class="container mx-auto flex justify-between items-center p-4">
      <!-- Logo/Brand -->
      <NuxtLink to="/" class="group flex items-center space-x-2">
        <div class="w-10 h-10 bg-gradient-to-br from-blue-400 to-purple-400 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
          <span class="text-white font-bold text-lg">LA</span>
        </div>
        <span class="text-2xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent group-hover:from-blue-300 group-hover:to-purple-300 transition-all duration-300">
          Leandro Afonso
        </span>
      </NuxtLink>
      ...
      <ul class="hidden md:flex space-x-8 text-lg">
        <li>
          ...
          >
            Home
            <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-blue-400 to-purple-400 group-hover:w-full transition-all duration-300" />
          </NuxtLink>
        </li>
        <li>
          <NuxtLink 
    ...
    >
      <div class="container mx-auto p-4 space-y-4">
        ...
        <NuxtLink 
          to="/projects" 
          class="block py-3 px-4 rounded-lg hover:bg-gray-800 transition-colors duration-300"
          :class="{ 'bg-gray-800 text-blue-400': $route.path.startsWith('/projects') }"
          @click="closeMobileMenu"
        >
          Projects
        </NuxtLink>
