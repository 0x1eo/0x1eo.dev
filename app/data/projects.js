...
export const projects = [
  ...
  },
  {
    ...
    tags: ['Angular', 'Node.js', 'Express.js', 'MongoDB', 'Socket.IO', 'JWT', 'REST API', 'Full-Stack']
  },
  {
    ...
    tags: ['Metasploit', 'Nmap', 'Suricata', 'pfSense', 'Penetration Testing', 'Vulnerability Exploitation', 'Red Teaming'],
    files: [
      {
        name: 'TPHE Report I',
        filename: 'TPHE_Relatorio_I.pdf',
        type: 'pdf',
        description: 'First evaluation report demonstrating penetration testing methodologies and findings'
      },
      {
        name: 'TPHE Report II',
        filename: 'TPHE_Relatorio_II.pdf',
        type: 'pdf',
        description: 'Second evaluation report covering advanced exploitation techniques and security assessments'
      }
    ]
  },
  {
    ...
    tags: ['NGINX', 'MariaDB Cluster', 'GlusterFS', 'Debian', 'High Availability', 'Load Balancing', 'Systems Engineering'],
    files: [
      {
        name: 'SC Report',
        filename: 'SC_Relatorio.pdf',
        type: 'pdf',
        description: 'Critical Systems project report detailing the high-availability web cluster implementation'
      }
    ]
  },
  {
    ...
    tags: ['Java', 'Maven', 'OOP', 'Design Patterns', 'JSON', 'HTML Generation', 'Game Simulation', 'Console UI'],
  },
  {
